...
nextflow run main.nf -resume -with-tower -profile cluster --reads /mnt/project/Aqua-Faang/dat/cscqtl/simulation/*{1,2}.fq.gz --circRNA $PWD/data/simulated_circRNA_list.txt
