...
workflow {
    ...
    CIRIQUANT_run(read_pairs_ch, params.circRNA)
}


process CIRIQUANT_run {
    container 'ndatth/ciriquant:v1.0.1'
    publishDir "${params.outdir}/ciriquant", mode: 'copy', overwrite: true
    cpus 32
    memory '64 GB'
    ...
    cq_convert_bed.sh $circRNA > ${pair_id}.bed
